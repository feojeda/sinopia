...
This document is the versionable source for the review strategy command.

Install targets:

- Antigravity 2.0 / Antigravity CLI: copy or sync this behavior into `.agents/skills/review-strategy/SKILL.md`.
- Codex local commands: copy or sync this behavior into `.codex/commands/review-strategy.md`.

Do not install this into `templates/commands/`; that directory is for commands delivered by `gsd-canva` to downstream projects.
